...
var filter_Geocube_GetXYZTile_0 = &utilities.DoubleArray{Encoding: map[string]int{"instance_id": 0, "x": 1, "y": 2, "z": 3}, Base: []int{1, 1, 2, 3, 4, 0, 0, 0, 0}, Check: []int{0, 1, 1, 1, 1, 2, 3, 4, 5}}
...
func RegisterGeocubeHandlerServer(ctx context.Context, mux *runtime.ServeMux, server GeocubeServer) error {
	mux.Handle(http.MethodGet, pattern_Geocube_GetXYZTile_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		var stream runtime.ServerTransportStream
		ctx = grpc.NewContextWithServerTransportStream(ctx, &stream)
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		annotatedContext, err := runtime.AnnotateIncomingContext(ctx, mux, req, "/geocube.Geocube/GetXYZTile", runtime.WithHTTPPathPattern("/v1/catalog/mosaic/{instance_id}/{x}/{y}/{z}/png"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := local_request_Geocube_GetXYZTile_0(annotatedContext, inboundMarshaler, server, req, pathParams)
		...
		forward_Geocube_GetXYZTile_0(annotatedContext, mux, outboundMarshaler, w, req, response_Geocube_GetXYZTile_0{resp.(*GetTileResponse)}, mux.GetForwardResponseOptions()...)
	})
...
// "GeocubeClient" to call the correct interceptors. This client ignores the HTTP middlewares.
func RegisterGeocubeHandlerClient(ctx context.Context, mux *runtime.ServeMux, client GeocubeClient) error {
	mux.Handle(http.MethodGet, pattern_Geocube_GetXYZTile_0, func(w http.ResponseWriter, req *http.Request, pathParams map[string]string) {
		ctx, cancel := context.WithCancel(req.Context())
		defer cancel()
		inboundMarshaler, outboundMarshaler := runtime.MarshalerForRequest(mux, req)
		annotatedContext, err := runtime.AnnotateContext(ctx, mux, req, "/geocube.Geocube/GetXYZTile", runtime.WithHTTPPathPattern("/v1/catalog/mosaic/{instance_id}/{x}/{y}/{z}/png"))
		if err != nil {
			runtime.HTTPError(ctx, mux, outboundMarshaler, w, req, err)
			return
		}
		resp, md, err := request_Geocube_GetXYZTile_0(annotatedContext, inboundMarshaler, client, req, pathParams)
		annotatedContext = runtime.NewServerMetadataContext(annotatedContext, md)
		if err != nil {
			runtime.HTTPError(annotatedContext, mux, outboundMarshaler, w, req, err)
			return
