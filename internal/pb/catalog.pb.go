...
func (x *ListDatasetsRequest) GetRecordsLister() isListDatasetsRequest_RecordsLister {
	if x != nil {
...
func (x *ListDatasetsRequest) GetRecords() *RecordIdList {
	if x != nil {
		if x, ok := x.RecordsLister.(*ListDatasetsRequest_Records); ok {
			return x.Records
		}
	}
	return nil
...
func (x *ListDatasetsRequest) GetFilters() *RecordFilters {
	if x != nil {
		if x, ok := x.RecordsLister.(*ListDatasetsRequest_Filters); ok {
			return x.Filters
		}
	}
	return nil
...
func (x *GetCubeRequest) GetRecordsLister() isGetCubeRequest_RecordsLister {
	if x != nil {
		return x.RecordsLister
	}
	return nil
...
func (x *GetCubeRequest) GetRecords() *RecordIdList {
	if x != nil {
		if x, ok := x.RecordsLister.(*GetCubeRequest_Records); ok {
			return x.Records
		}
	}
	return nil
...
func (x *GetCubeRequest) GetFilters() *RecordFilters {
	if x != nil {
		if x, ok := x.RecordsLister.(*GetCubeRequest_Filters); ok {
			return x.Filters
		}
	}
	return nil
...
func (x *GetCubeRequest) GetGroupedRecords() *GroupedRecordIdsList {
	if x != nil {
		if x, ok := x.RecordsLister.(*GetCubeRequest_GroupedRecords); ok {
			return x.GroupedRecords
		}
	}
	return nil
...
func (x *GetCubeResponse) GetResponse() isGetCubeResponse_Response {
	if x != nil {
		return x.Response
	}
	return nil
...
func (x *GetCubeResponse) GetGlobalHeader() *GetCubeResponseHeader {
	if x != nil {
		if x, ok := x.Response.(*GetCubeResponse_GlobalHeader); ok {
...
func (x *GetCubeResponse) GetHeader() *ImageHeader {
	if x != nil {
		if x, ok := x.Response.(*GetCubeResponse_Header); ok {
			return x.Header
		}
	}
	return nil
...
func (x *GetCubeResponse) GetChunk() *ImageChunk {
	if x != nil {
		if x, ok := x.Response.(*GetCubeResponse_Chunk); ok {
			return x.Chunk
		}
	}
	return nil
...
func (x *GetCubeMetadataResponse) GetResponse() isGetCubeMetadataResponse_Response {
	if x != nil {
		return x.Response
	}
	return nil
...
func (x *GetCubeMetadataResponse) GetGlobalHeader() *GetCubeResponseHeader {
	if x != nil {
		if x, ok := x.Response.(*GetCubeMetadataResponse_GlobalHeader); ok {
			return x.GlobalHeader
		}
	}
	return nil
...
func (x *GetCubeMetadataResponse) GetHeader() *ImageHeader {
	if x != nil {
		if x, ok := x.Response.(*GetCubeMetadataResponse_Header); ok {
			return x.Header
		}
	}
	return nil
...
func (x *GetCubeMetadataResponse) GetChunk() *ImageChunk {
	if x != nil {
		if x, ok := x.Response.(*GetCubeMetadataResponse_Chunk); ok {
			return x.Chunk
		}
	}
	return nil
...
func (x *GetTileRequest) GetRecordsLister() isGetTileRequest_RecordsLister {
	if x != nil {
		return x.RecordsLister
	}
	return nil
...
func (x *GetTileRequest) GetRecords() *GroupedRecordIds {
	if x != nil {
		if x, ok := x.RecordsLister.(*GetTileRequest_Records); ok {
			return x.Records
		}
	}
	return nil
...
func (x *GetTileRequest) GetFilters() *RecordFilters {
	if x != nil {
		if x, ok := x.RecordsLister.(*GetTileRequest_Filters); ok {
			return x.Filters
		}
	}
	return nil
...
const file_pb_catalog_proto_rawDesc = "" +
	"\n" +
	"\x10pb/catalog.proto\x12\ageocube\x1a\x13pb/dataformat.proto\x1a\x10pb/records.proto\x1a\x10pb/layouts.proto\x1a\x14pb/datasetMeta.proto\x1a\x12pb/variables.proto\"C\n" +
	"\x05Shape\x12\x12\n" +
	"\x04dim1\x18\x01 \x01(\x05R\x04dim1\x12\x12\n" +
	"\x04dim2\x18\x02 \x01(\x05R\x04dim2\x12\x12\n" +
	"\x04dim3\x18\x03 \x01(\x05R\x04dim3\"\x84\x03\n" +
	"\vImageHeader\x12$\n" +
	"\x05shape\x18\x01 \x01(\v2\x0e.geocube.ShapeR\x05shape\x12/\n" +
	"\x05dtype\x18\x02 \x01(\x0e2\x19.geocube.DataFormat.DtypeR\x05dtype\x12\x19\n" +
	"\bnb_parts\x18\x04 \x01(\x05R\anbParts\x12\x12\n" +
	"\x04data\x18\x03 \x01(\fR\x04data\x12\x12\n" +
	"\x04size\x18\x05 \x01(\x03R\x04size\x12(\n" +
	"\x05order\x18\x06 \x01(\x0e2\x12.geocube.ByteOrderR\x05order\x12 \n" +
	"\vcompression\x18\a \x01(\bR\vcompression\x12@\n" +
	"\x0fgrouped_records\x18\v \x01(\v2\x17.geocube.GroupedRecordsR\x0egroupedRecords\x127\n" +
	"\fdataset_meta\x18\n" +
	" \x01(\v2\x14.geocube.DatasetMetaR\vdatasetMeta\x12\x14\n" +
	"\x05error\x18\t \x01(\tR\x05error\"4\n" +
	"\n" +
	"ImageChunk\x12\x12\n" +
	"\x04part\x18\x01 \x01(\x05R\x04part\x12\x12\n" +
	...
	"instanceId\x121\n" +
	"\arecords\x18\x02 \x01(\v2\x15.geocube.RecordIdListH\x00R\arecords\x122\n" +
	"\afilters\x18\x03 \x01(\v2\x16.geocube.RecordFiltersH\x00R\afiltersB\x10\n" +
	"\x0erecords_lister\"|\n" +
	"\x14ListDatasetsResponse\x12)\n" +
	"\arecords\x18\x01 \x03(\v2\x0f.geocube.RecordR\arecords\x129\n" +
	"\rdataset_metas\x18\x02 \x03(\v2\x14.geocube.DatasetMetaR\fdatasetMetas\"\xbe\x04\n" +
	"\x0eGetCubeRequest\x121\n" +
	"\arecords\x18\v \x01(\v2\x15.geocube.RecordIdListH\x00R\arecords\x122\n" +
	"\afilters\x18\x02 \x01(\v2\x16.geocube.RecordFiltersH\x00R\afilters\x12H\n" +
	"\x0fgrouped_records\x18\f \x01(\v2\x1d.geocube.GroupedRecordIdsListH\x00R\x0egroupedRecords\x12!\n" +
	"\finstances_id\x18\x03 \x03(\tR\vinstancesId\x12\x10\n" +
	"\x03crs\x18\x04 \x01(\tR\x03crs\x123\n" +
	"\n" +
	"pix_to_crs\x18\x05 \x01(\v2\x15.geocube.GeoTransformR\bpixToCrs\x12!\n" +
	"\x04size\x18\x06 \x01(\v2\r.geocube.SizeR\x04size\x12+\n" +
	"\x11compression_level\x18\a \x01(\x05R\x10compressionLevel\x12!\n" +
	"\fheaders_only\x18\b \x01(\bR\vheadersOnly\x12+\n" +
	"\x06format\x18\t \x01(\x0e2\x13.geocube.FileFormatR\x06format\x12:\n" +
	"\x0eresampling_alg\x18\n" +
	" \x01(\x0e2\x13.geocube.ResamplingR\rresamplingAlg\x12#\n" +
	"\rprotocol_v11x\x18\r \x01(\bR\fprotocolV11xB\x10\n" +
	"\x0erecords_lister\"\x8d\x02\n" +
	"\x15GetCubeResponseHeader\x12\x14\n" +
	"\x05count\x18\x01 \x01(\x03R\x05count\x12\x1f\n" +
	"\vnb_datasets\x18\x02 \x01(\x03R\n" +
	"nbDatasets\x124\n" +
	"\vref_dformat\x18\x03 \x01(\v2\x13.geocube.DataFormatR\n" +
	"refDformat\x12:\n" +
	"\x0eresampling_alg\x18\x04 \x01(\x0e2\x13.geocube.ResamplingR\rresamplingAlg\x129\n" +
	"\fgeotransform\x18\x05 \x01(\v2\x15.geocube.GeoTransformR\fgeotransform\x12\x10\n" +
	"\x03crs\x18\x06 \x01(\tR\x03crs\"\xc1\x01\n" +
	"\x0fGetCubeResponse\x12E\n" +
	"\rglobal_header\x18\x03 \x01(\v2\x1e.geocube.GetCubeResponseHeaderH\x00R\fglobalHeader\x12.\n" +
	"\x06header\x18\x01 \x01(\v2\x14.geocube.ImageHeaderH\x00R\x06header\x12+\n" +
	"\x05chunk\x18\x02 \x01(\v2\x13.geocube.ImageChunkH\x00R\x05chunkB\n" +
	"\n" +
	"\bresponse\"\xe5\x03\n" +
	"\x16GetCubeMetadataRequest\x129\n" +
	"\rdatasets_meta\x18\x01 \x03(\v2\x14.geocube.DatasetMetaR\fdatasetsMeta\x12@\n" +
	"\x0fgrouped_records\x18\x02 \x03(\v2\x17.geocube.GroupedRecordsR\x0egroupedRecords\x124\n" +
	"\vref_dformat\x18\x03 \x01(\v2\x13.geocube.DataFormatR\n" +
	"refDformat\x12:\n" +
	"\x0eresampling_alg\x18\x04 \x01(\x0e2\x13.geocube.ResamplingR\rresamplingAlg\x123\n" +
	"\n" +
	"pix_to_crs\x18\x05 \x01(\v2\x15.geocube.GeoTransformR\bpixToCrs\x12\x10\n" +
	"\x03crs\x18\x06 \x01(\tR\x03crs\x12!\n" +
	"\x04size\x18\a \x01(\v2\r.geocube.SizeR\x04size\x12+\n" +
	"\x06format\x18\b \x01(\x0e2\x13.geocube.FileFormatR\x06format\x12 \n" +
	"\vpredownload\x18\t \x01(\bR\vpredownload\x12#\n" +
	"\rprotocol_v11x\x18\n" +
	" \x01(\bR\fprotocolV11x\"\xc9\x01\n" +
	"\x17GetCubeMetadataResponse\x12E\n" +
	"\rglobal_header\x18\x03 \x01(\v2\x1e.geocube.GetCubeResponseHeaderH\x00R\fglobalHeader\x12.\n" +
	"\x06header\x18\x01 \x01(\v2\x14.geocube.ImageHeaderH\x00R\x06header\x12+\n" +
	"\x05chunk\x18\x02 \x01(\v2\x13.geocube.ImageChunkH\x00R\x05chunkB\n" +
	"\n" +
	...
	"\x01z\x18\x04 \x01(\x05R\x01z\x12\x10\n" +
	"\x03min\x18\b \x01(\x02R\x03min\x12\x10\n" +
	"\x03max\x18\t \x01(\x02R\x03max\x125\n" +
	"\arecords\x18\x06 \x01(\v2\x19.geocube.GroupedRecordIdsH\x00R\arecords\x122\n" +
	"\afilters\x18\a \x01(\v2\x16.geocube.RecordFiltersH\x00R\afiltersB\x10\n" +
	"\x0erecords_lister\";\n" +
	"\x0fGetTileResponse\x12(\n" +
	"\x05image\x18\x01 \x01(\v2\x12.geocube.ImageFileR\x05image*,\n" +
	"\tByteOrder\x12\x10\n" +
	"\fLittleEndian\x10\x00\x12\r\n" +
	"\tBigEndian\x10\x01* \n" +
	"\n" +
	"FileFormat\x12\a\n" +
	"\x03Raw\x10\x00\x12\t\n" +
	"\x05GTiff\x10\x01B\x0eZ\f./pb;geocubeb\x06proto3"
